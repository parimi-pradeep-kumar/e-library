...
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500&display=swap" rel="stylesheet">
	...
	<body>
		<div id="container">
			...
			<div id="wrapper">
				<h3 id="heading" class="text-primary">View Request Details</h3>
				<?php
					$sql="SELECT student.NAME,request.MES,request.LOGGS from student INNER JOIN request on student.ID=request.ID";
					$res=$db->query($sql);
					if($res->num_rows>0)
					{
						echo "<table>
